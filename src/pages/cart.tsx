...
const cart = () => {
  return (
    ...
    { x === 1?
  <section className='bg-gray-100 px-52 py-10 grid grid-cols-12 content-center gap-10'>
    {/* Head */}
    ...
    <div className="col-span-2 flex items-center justify-center gap-5">
        <div className="flex items-center  bg-white">
          ...
          <div className="text-2xl cursor-pointer hover:bg-black hover:text-white">+</div>
          <hr className='border border-gray-200'/>
          <div className="text-2xl cursor-pointer hover:bg-black hover:text-white">-</div>
          </div>
         <p className='p-4 text-center cursor-pointer'>1</p>
        </div>
    ...
    <div className="flex flex-col gap-5">
      <p className='text-2xl text-right'>Subtotal: $100.00</p>
